...
import 'package:digitalproductstore/provider/contact/contact_us_provider.dart';
...
import 'package:digitalproductstore/viewobject/holder/contact_us_holder.dart';
...
class PsButtonWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialButton(
        ...
        child: Text(
          Utils.getString(context, 'contact_us__submit'),
        ),

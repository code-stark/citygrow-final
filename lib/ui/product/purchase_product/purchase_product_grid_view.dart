...
// }
class PurchasedProductGridView extends StatefulWidget {
  const PurchasedProductGridView(
      {Key key, @required this.animationController})
      : super(key: key);
  final AnimationController animationController;
  @override
  _PurchasedProductGridView createState() =>
      _PurchasedProductGridView();
}

class _PurchasedProductGridView
    extends State<PurchasedProductGridView>
    with TickerProviderStateMixin {
  final ScrollController _scrollController = ScrollController();
  ...
  Widget build(BuildContext context) {
    ...
    return EasyLocalizationProvider(
        ...
        child: ChangeNotifierProvider<PurchasedProductProvider>(
          create: (BuildContext context) {
            final PurchasedProductProvider provider =
          ...
          child: Consumer<PurchasedProductProvider>(
            builder: (BuildContext context,
                PurchasedProductProvider provider, Widget child) {
              return StreamBuilder<QuerySnapshot>(
                  ...
                  builder: (context, snapshot) {
                    ...
                    return Stack(children: <Widget>[
                      ...
                      PSProgressIndicator(
                          provider.purchasedProductList.status)
                    ]);
                  });
            },
          ),

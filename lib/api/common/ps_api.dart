import 'dart:convert';
import 'dart:io';
import 'package:digitalproductstore/api/common/ps_api_reponse.dart';
...
abstract class PsApi {
  ...
  Future<List<dynamic>> getList(String url) async {
    ...
    try {
      final Response response = await client.get('$ps_app_url$url');
  ...
  Future<PsResource<R>> postUploadImage<T extends PsObject<dynamic>, R>(T obj,
    ...
    try {
      ...
      final Uri uri = Uri.parse('$ps_app_url$url');

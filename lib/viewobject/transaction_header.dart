  ...
  TransactionHeader fromMap(dynamic dynamicData) {
    if (dynamicData != null) {
      return TransactionHeader(
          ...
          transStatusId: dynamicData['updated_status_id'],
          currencySymbol: dynamicData['currency_symbol'],
          currencyShortForm: dynamicData['updated_short_form'],
          transCode: dynamicData['trans_code'],
          billingFirstName: dynamicData['billing_first_name'],
          billingLastName: dynamicData['billing_second_name'],
          ...
          shippingLastName: dynamicData['billing_second_name'],
